                        ...
                        <div class="widget-1 widget-facility">
                            <div class="widget-1-body">
                                <ul>
                                    <li>
                                        <a href="#0">
                                            <span class="img"><img src="https://i.ibb.co/TvHkPph/sidebar01.png" alt="sidebar" /></span>
                                            <span class="cate">24X7 Care</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#0">
                                            <span class="img"><img src="https://i.ibb.co/V9rs9vG/sidebar02.png" alt="sidebar" /></span>
                                            <span class="cate">100% Assurance</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#0">
                                            <span class="img"><img src="https://i.ibb.co/KxcT3kw/sidebar03.png" alt="sidebar" /></span>
